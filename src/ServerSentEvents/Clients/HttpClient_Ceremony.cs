...
namespace ServerSentEvents
{
    ...
    // what you really want to do." (Venkat Subramaniam)
    public partial class HttpClient : IEquatable<HttpClient>
    {
        public override string ToString()
            => _id.ToString();

        public bool Equals(HttpClient? other)
            => other is object && _id.Equals(other._id);

        public override bool Equals(object? obj)
            => obj is HttpClient other && Equals(other);
